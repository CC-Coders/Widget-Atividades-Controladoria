var AtividadesControladoriaNovo = SuperWidget.extend({
...
async function CriaListaAtividadeControl() {
    var [ListaDeAtividades, ComprasEServicos] = await BuscaListagemDasAtividadesDaControladoria();
    var stringHTML = '';
    ...
    <td>" + ComprasEServicos[0].QNTD + "</td>\
    " + (SeMostraColunaHoje ? "<td>" + ComprasEServicos[0].Hoje + "</td>" : "") + "\
</tr>";
    ...
    async function BuscaListagemDasAtividadesDaControladoria() {
        ...
        var ds1 = await ExecutaDataset("ListaAtividadesDaControladoriaNoFluig", null, [
        ...
        var ds2 = await ExecutaDataset("ListaAtividadesDaControladoriaNoFluig", null, [
            DatasetFactory.createConstraint("Operacao", "SolicitacoesDeComprasEServicos", "SolicitacoesDeComprasEServicos", ConstraintType.MUST),
            DatasetFactory.createConstraint("Mes", mes, mes, ConstraintType.MUST),
            DatasetFactory.createConstraint("Ano", ano, ano, ConstraintType.MUST),
            DatasetFactory.createConstraint("Dia", dia, dia, ConstraintType.MUST)
        ], null);
